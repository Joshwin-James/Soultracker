...
const SignUpPage: React.FC = () => {
  ...
  return (
    <>
    <div className="min-h-screen bg-calm-blue-50 flex flex-col justify-center py-12 sm:px-6 lg:px-8">
      <div className="sm:mx-auto sm:w-full sm:max-w-md">
        <div className="flex justify-center items-center">
            <HeartPulse className="h-12 w-12 text-warm-purple-600" />
            <h2 className="ml-4 text-center text-3xl font-extrabold text-gray-900">Create your account</h2>
        </div>
      </div>
    ...
    <Modal isOpen={isModalOpen} onClose={handleCloseModal} title="Verification Email Sent">
        <p className="text-gray-600">Please check your inbox to verify your email address. Once verified, you can log in to your new account.</p>
        <div className="mt-6">
