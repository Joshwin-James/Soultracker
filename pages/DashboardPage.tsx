    ...
    return (
        <div className="relative w-48 h-48 flex items-center justify-center">
            <svg className="w-full h-full transform -rotate-90">
                <circle cx="50%" cy="50%" r="45%" strokeWidth="10%" stroke="currentColor" className="text-gray-200" fill="transparent"/>
  ...
  return (
    <div className="space-y-6 animate-slide-in-up">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center justify-center space-y-2">
                <Flame className="w-12 h-12 text-orange-500"/>
                <p className="text-4xl font-bold text-gray-800">{user?.currentStreak}</p>
                <p className="text-gray-500">Day Streak</p>
            </div>
            <div className="bg-white p-6 rounded-lg shadow-md flex flex-col items-center justify-center space-y-2">
                <Award className="w-12 h-12 text-yellow-500"/>
                <p className="text-4xl font-bold text-gray-800">{user?.userPoints}</p>
                <p className="text-gray-500">Total Points</p>
            </div>
        </div>

        <div className="bg-white p-6 rounded-lg shadow-md">
            <h2 className="text-xl font-semibold text-gray-700 mb-4">Your Recent Emotions</h2>
